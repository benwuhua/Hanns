...
| HNSW (1M, M=16) | 1M | **199s** (parallel, 8t) | **6,374** | ef=50, recall=0.125; was 317s (parallel shrink), was 938s serial |
...
| PQFlash PQ32 SIFT-1M (disk V3, io_uring) | 1M | 642s | **1,063** | recall@10=0.9114, V3 236B/node, group=8; cloud VM IOPS ceiling ~30MB/s (2026-03-26, x86) |
| PQFlash PQ32 SIFT-1M (in-memory) | 1M | ~200s | **2,074** | recall@10=0.9146, cache_all_on_load=true (NOT disk) |
